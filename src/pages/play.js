...
import { baseSepolia, bscTestnet, lineaSepolia } from "thirdweb/chains";
...
function Play() {
  ...
  const contract = getContract({
    ...
    address: "0x52a2b00bd010Fd715eE9ca68DFd98A530ae001Af", //stake contract
  ...
  const tokenContract = getContract({
    client,
    chain: lineaSepolia,
    address: "0xb8FEA2F4bfFf8801C367EEAfb8241E9f46a99936",
  });
